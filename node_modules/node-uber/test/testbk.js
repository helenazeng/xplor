...
console.log(uber.getAuthorizeUrl(['profile']));
// uber.authorization({ authorization_code: 'iSAXhvlOJpxU3JSrWvmt31wTlm57L0' }, function (err, accessToken, refreshToken) {
//   console.log(err);
...
// uber.authorization({ authorization_code: 'XcrP48bC2hA9O3ku8DaV72wDU46jhr' }, function (err, accessToken, refreshToken) {
//   console.log(accessToken);
//   console.log(refreshToken);
// });

// uber.user.activity({
//   access_token: 'ok9lrmMxBqZa0BKQnhPHB5LDWcrQNK'
// }, function (err, res) {
//   console.log(err);
//   console.log(res);
// })
